...
CHANNELS_ADDALL = 'channels.addAll'
CHANNELS_ADDOWNER = 'channels.addOwner'
...
API_DATA = {
  ...
  USERS_LIST: { 'method': 'GET' },
  CHANNELS_HISTORY: { 'method': 'GET' },
  CHANNELS_INFO: { 'method': 'GET' },
  CHANNELS_MESSAGES: { 'method': 'GET' },
  CHANNELS_LIST: { 'method': 'GET' },
  CHANNELS_LIST_JOINED: { 'method': 'GET' },
  CHANNELS_ADDALL: { 'method': 'POST' },
  CHANNELS_ADDOWNER: { 'method': 'POST' },
  CHANNELS_INVITE: { 'method': 'POST' }
}
...
class API:
    ...
    def users_list(self, offset = 0):

        request = RequestBuilder(
                api = self,
                apiName = USERS_LIST).build(
                    params = {
                        'count': 50,
                        'offset': offset,
                    })
    ...
    def channels_info(self, roomName):
        request = RequestBuilder(
                api = self,
                apiName = CHANNELS_INFO).build(params = { 'roomName': roomName })
    ...
    def channels_addAll(self, roomId, activeUsersOnly = False):
        data = { 'roomId': roomId, 'activeUsersOnly': activeUsersOnly }

        obj = json.dumps(data);
        request = RequestBuilder(
                api = self,
                apiName = CHANNELS_ADDALL).build(data = obj)
    ...
    def channels_addOwner(self, roomId, userId):
        data = { 'roomId': roomId, 'userId': userId }

        obj = json.dumps(data);
        request = RequestBuilder(
                api = self,
                apiName = CHANNELS_ADDOWNER).build(data = obj)
    ...
    def channels_invite(self, roomId, userId):
        ...
        request = RequestBuilder(
                api = self,
                apiName = CHANNELS_INVITE).build(data = obj)
